...
<script type="text/javascript">
    $(function(){
       $.ajax({
		   type:"post",
		   url:"${pageContext.request.contextPath}/emp/getEmployee",
...
<form name="form2" id="form" method="post" action="${pageContext.request.contextPath}/email/saveInfo">
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<textarea name="content" rows=15 cols=130>
