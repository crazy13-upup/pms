...
<tr align="center" bgcolor="#FAFAF1" height="22">
    ...
    <c:forEach items="${list}" var="module" varStatus="index">
        <tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
            <td><input name="id" value="${module.id}" type="checkbox" id="id" value="101" class="np"></td>
            <td>${index.count}</td>
            <td align="center"><a href=''><u></u></a>${module.modname}</td>
            <td align="center"><a href=''><u></u></a>${module.analysis.title}</td>
            <td align="center"><a href=''><u></u></a>${module.project.pname}</td>
            <td>${module.level}</td>
            <td>${module.simpledis}</td>
            <td>${module.remark}</td>
