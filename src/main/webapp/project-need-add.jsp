...
<script type="text/javascript">
	...
	//先发送ajax请求将所有的没有需求分析的项目名称查出来
	$(function(){
	    $.ajax({
			type:"get",
			url:"${pageContext.request.contextPath}/pro/jsonListNoAna",
			success:function(msg){
			    //遍历list，得到每一个project中的项目名称
...
<form name="form2" id="form2" action="${pageContext.request.contextPath}/analy/insert" method="post">
...
<td height="28" colspan=4 align=center>
	&nbsp;
	<a href="javascript:insertAnalysis()" class="coolbg">保存</a>
