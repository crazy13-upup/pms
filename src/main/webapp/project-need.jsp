...
<tr bgcolor="#E7E7E7">
    ...
    <c:forEach items="${list}" var="analysis" varStatus="index">
        <tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
            <td><input name="id" value="${analysis.id}" type="checkbox" id="id" value="101" class="np"></td>
            <td>${index.count}</td>
            <td>${analysis.title}</td>
            <td align="center"><a href=''><u></u></a>${analysis.proname}</td>

            <td> <fmt:formatDate value="${analysis.addtime}" pattern="yyyy-MM-dd"></fmt:formatDate></td>
            <td> <fmt:formatDate value="${analysis.updatetime}" pattern="yyyy-MM-dd"></fmt:formatDate></td>

            <td><a href="${pageContext.request.contextPath}/project-need-edit.jsp">编辑</a> | <a href="${pageContext.request.contextPath}/project-need-look.jsp">查看详情</a></td>
        </tr>
