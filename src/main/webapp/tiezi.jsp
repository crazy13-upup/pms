...
<form action="${pageContext.request.contextPath}/tz/savaInfo" method="post" >
    <input type="text" name="forumtitle" placeholder="请输入题目"><br/>
    <script id="editor" name="forumcontent" type="text/plain" style="width:1024px;height:500px;"></script><br>
